        ...
        try:
            if opcion == "1":
                ...
                if not nombre_cliente or not direccion:
                    raise CampoVacioError("El nombre y la direccion son obligatorios.")
                cliente = Cliente(nombre_cliente, direccion)
                
                tipo = input("Tipo de comida (pizza/empanada): ").strip().lower()
                separador()
                if not tipo:
                    raise CampoVacioError("Debe especificar el tipo de comida.")
                ...
                if tipo == "pizza":
                    ...
                    separador()
                    if not gusto or not size:
                        raise CampoVacioError("El gusto y el tamaño de la pizza son obligatorios.")
                    ...
                    separador()
                    if not gusto or not cantidad:
                        raise CampoVacioError("El gusto y la cantidad de empanadas son obligatorios.")
